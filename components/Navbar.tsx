    ...
    <header className="bg-white shadow-md sticky top-0 z-50 border-b-2 border-amber-950">
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-16">
        ...
        <div className="flex items-center space-x-4">
          ...
          {isMenuOpen?
               <X  size={28} className="text-gray-700 hover:text-gray-900 cursor-pointer transition" onClick={() => setIsMenuOpen(!isMenuOpen)}  /> 
      ...
      <div className="px-2 text-black" >
          { isMenuOpen &&(
              <ul className="space-y-2">
                ...
                <li><Link href="/" onClick={() => setIsMenuOpen(!isMenuOpen)}>Shop</Link></li>
